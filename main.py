...
class App:
    ...
    def login(self):
        ...
        #     model_dir='\Desktop\python_faceliveliness\face-attendance-system\Silent-Face-Anti-Spoofing-master\resources\anti_spoof_models',
        #     device_id=0
        # )
    ...
    def logout(self):
        ...
        # label = test(
        #     image=self.most_recent_capture_arr,
        #     model_dir='\Desktop\pythonfaceliveliness\face-attendance-system\Silent-Face-Anti-Spoofing-master\resources\anti_spoof_models',
        #     device_id=0
        # )
